-- ============================================================
-- 129: get_person_360 - kullanici kendi 360 verisini gorebilsin
-- ============================================================
-- Onceki surumde fonksiyon yalnizca admin/koc tarafindan
-- cagrilabiliyordu. Artik her kullanici KENDI verisini gorebilir;
-- baskasinin verisi icin admin/koc yetkisi gerekir.
-- ============================================================
...
DECLARE
    ...
    v_load        JSONB;
BEGIN
    -- Kullanici kendi verisini gorebilir; baskasi icin admin/koc gerekir.
